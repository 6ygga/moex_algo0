...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    d1 = bt.feeds.GenericCSVData(  # Получаем историю из файла - в котором нет последних 5 дней
        ...
        dataname=f'{symbol}_{tf}_minus_5_days.csv',  # Файл для импорта из MOEX. Создается из примера 02 - Symbol data_loader to DF.py
    ...
    fromdate = dt.datetime.now() - dt.timedelta(days=15)  # берем данные за последние 15 дней
